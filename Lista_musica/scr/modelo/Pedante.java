...
public class Pedante extends Critico{
	...
	public Pedante(Musica musica_analisda) {
		apelidos_degradantes.add("ignorante");
		apelidos_degradantes.add("seu alienado");
		frases_negativas.add("a harmonia é tão previsível");
		frases_negativas.add("espero não ouvir isso de novo");
