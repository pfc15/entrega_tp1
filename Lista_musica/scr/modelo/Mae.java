...
public class Mae extends Critico {
	...
	public Mae(Musica analise) {
		nome = "mãe";
		apelidos_carinhosos.add("carinho");
		apelidos_carinhosos.add("amor");
		frases_positivas.add("muito interessante");
		frases_positivas.add("acho que ouvi no radio hoje de manhã");
